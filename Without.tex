...
\PassOptionsToPackage{hyphens}{url}\usepackage[xetex,
            ...
            pagebackref,
            linktoc=all,
            pdftitle={A world without things},
...
\newfontfamily\fanciestfont[Ligatures={TeX,Discretionary}]{Minion Pro}
...
\title{A world without things \\ Essays in moral philosophy}
\date{}
\maketitle
...
\newgeometry{top=2.170cm,
            ...
            outer=2.1835cm,
            ignoremp}
\part{Historical background and moral foundations}
...
\chapter{Treating all like others}
As we see in \refse{se:weird}\citep{kantcritiquepower2000}
\chapter{All the world is a stage}
\label{ch:stage}
\section{weird shit}
\label{se:weird}
%\input{math}
